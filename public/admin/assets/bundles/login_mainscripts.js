...
$(function () {
    ...
    $("#main-menu").metisMenu(), $("#left-sidebar .sidebar-scroll").slimScroll({
        ...
        _body.hasClass("layout-fullwidth") ? _body.removeClass("layout-fullwidth") : _body.addClass("layout-fullwidth"), $(this).find(".fa").toggleClass("fa-arrow-left fa-arrow-right")
    }), $(".btn-toggle-offcanvas").on("click", function () {
        _body.toggleClass("offcanvas-active")
    }), $("#main-content").on("click", function () {
        _body.removeClass("offcanvas-active")
    ...
    }), $("#top_open_setting").on("click", function () {
        $(".themesetting").toggleClass("open")
        ...
        console.log(e), _body.removeClass(e).addClass(this.value)
    }), $(".setting_switch .lv-btn").on("change", function () {
        this.checked ? _body.addClass("light_version") : _body.removeClass("light_version")
    }), $(".setting_switch .mini-sidebar-btn").on("change", function () {
        this.checked ? (_body.addClass("mini_sidebar"), $("#left-sidebar").addClass("mini_sidebar_on"), $(".hmenu-btn").attr("disabled", "disabled")) : (_body.removeClass("mini_sidebar"), $("#left-sidebar").removeClass("mini_sidebar_on"), $(".hmenu-btn").removeAttr("disabled", "disabled"))
    }), $("#left-sidebar").hover(function () {
        _body.toggleClass("mini_hover"), $("#left-sidebar").toggleClass("mini_sidebar_on")
    }), $(".setting_switch .hmenu-btn").on("change", function () {
        this.checked ? (_body.addClass("h-menu"), $(".mini-sidebar-btn").attr("disabled", "disabled")) : (_body.removeClass("h-menu"), $(".mini-sidebar-btn").removeAttr("disabled", "disabled"))
    }), $(".setting_switch .rtl-btn").on("change", function () {
        this.checked ? _body.addClass("rtl") : _body.removeClass("rtl")
    })
