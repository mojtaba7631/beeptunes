...
function closure ( target, options, originalOptions ){
	...
	function fixEvent ( e, pageOffset ) {
		...
		// attempting to slide. The tap events also depends on this.
		e.preventDefault();
	...
	function end ( event, data ) {
		...
		// If this is a standard handle movement, fire the end events.
	...
	function tap ( event ) {
		...
		// The tap events shouldn't propagate up and cause 'edge' to run.
		event.stopPropagation();
	...
	function valueSet ( input, fireSetEvent ) {
		...
		// Fire the 'set' events for both handles.
	...
	function updateOptions ( optionsToUpdate, fireSetEvent ) {
		...
		// 'snap' and 'step' can be updated, 'direction' cannot, due to events binding.
