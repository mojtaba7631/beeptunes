...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.initialize = function () {
        ...
        // init content before set events
...
var Dropzone = /** @class */ (function () {
    ...
    Dropzone.prototype.attachDragAndDropEvent = function () {
        ...
        }).on('dragover', false); // prevent default dragover events
    };
                ...
                children: [
                    ...
                    _this.ui.dropdown({
                        items: [
                            ...
                            '  <div>',
                            '    <button type="button" class="note-color-reset btn btn-light" data-events="backColor" data-value="inherit">',
                            _this.lang.color.transparent,
                            '    </button>',
                            '  </div>',
                            '  <div class="note-holder" data-events="backColor"/>',
                            '</div>',
                            '<div class="note-palette">',
                            '  <div class="note-palette-title">' + _this.lang.color.foreground + '</div>',
                            '  <div>',
                            '    <button type="button" class="note-color-reset btn btn-light" data-events="removeFormat" data-value="foreColor">',
                            _this.lang.color.resetToDefault,
                            '    </button>',
                            '  </div>',
                            '  <div class="note-holder" data-events="foreColor"/>',
                            '</div>'
                        ].join(''),
            ...
            return _this.ui.buttonGroup([
                ...
                _this.ui.dropdown({
                    ...
                    items: [
                        ...
                        '  <div class="note-dimension-picker-mousecatcher" data-events="insertTable" data-value="1x1"/>',
...
var LinkDialog = /** @class */ (function () {
    ...
    /**
     * Show link dialog and set events handlers on dialog controls.
     *
     * @param {Object} linkInfo
     * @return {Promise}
     */
