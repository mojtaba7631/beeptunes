    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{route('admin.events_update_panel',['event_id' => $event_info['id']])}}" method="post" class="row">
                            @csrf
                            <div class="col-12 col-sm-5 col-md-3">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        @enderror
                                        <input data-default-file="{{asset($event_info['event_image'])}}" name="event_image" type="file" class="form-control dropify">
                                    </div>
                                    ...
                                    <div class="col-12  mt-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{$event_info_date}}" type="text" class="form-control datePicker whiteReadOnly" name="event_date">
                                    </div>
                                    ...
                                    <div class="col-12  mt-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{$event_info['price']}}" type="text" class="form-control datePicker whiteReadOnly" name="price">
                                    </div>
                            ...
                            <div class="col-12 col-sm-7 col-md-9">
                                <div class="row">
                                    <div class="col-12 col-md-4 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{$event_info['event_title']}}" name="event_title" type="text" class="form-control">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-8 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{$event_info['short_title']}}" type="text" class="form-control" name="short_title">
                                    </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{$event_info['event_date_counter']}}" type="text" class="form-control text-right"
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <textarea name="event_content" class="summernote">{{$event_info['event_content']}}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <div class="input-group demo-tagsinput-area">
                                            <input name="event_meta_keywords" type="text" class="form-control"
                                                   value="{{$event_info['event_meta_keywords']}}" data-role="tagsinput">
                                        </div>
                                    </div>
                                </div>
