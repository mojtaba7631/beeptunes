    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{route('admin.test_store_panel')}}" method="post" class="row">
                            @csrf
                            <div class="col-12 col-sm-5 col-md-3">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        @enderror
                                        <input name="test_image" type="file" class="form-control dropify">
                                    </div>
                            ...
                            <div class="col-12 col-sm-7 col-md-9">
                                <div class="row">
                                    <div class="col-12 col-md-8 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('test_name')}}" name="test_name" type="text" class="form-control">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('test_slug')}}" type="text" class="form-control" name="test_slug">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <textarea name="test_description" class="summernote">{{old('test_description')}}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <div class="input-group demo-tagsinput-area">
                                            <input name="test_meta_keywords" type="text" class="form-control"
                                                   value="{{old('test_meta_keywords')}}" data-role="tagsinput">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mb-4">
                                        ...
                                        <span class="validation_label_error">{{$message}}</span>
                                        @enderror
                                        <input value="{{old('test_meta_description')}}" type="text" class="form-control" name="test_meta_description">
                                    </div>
                                </div>
